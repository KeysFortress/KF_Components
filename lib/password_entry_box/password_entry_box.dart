...
class PasswordEntryBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder.reactive(
      ...
      builder: (context, viewModel, child) => viewModel.isCopyActionPresent
          ? Container(
              ...
              child: Column(
                children: [
                  ...
                  Expanded(
                    child: CopyPasswordWarningBox(
                      onSaveCallback: () async {
                        await viewModel.onConfirmCopy(
                          viewModel.password,
                        );
                        onSave.call();
                      },
                      onCancelPressed: () {
                        viewModel.observer.getObserver(
                          "reload_passwords",
                          null,
                        );
                        onSave.call();
                      },
                      entryType: PasswordWarningBoxType.onGenerate,
                    ),
                  ),
                ],
              ),
                      ...
                      Column(
                        children: [
                          ...
                          CustomSlider(
                            ...
                            maxValue: 512,
                            divisios: 512,
                            slidingStopped: (value) =>
                                viewModel.applyLenght(value),
                          ),
                          Row(
